      ...
      <div className="container-custom">
        ...
        >
          ...
          <h2 className="text-4xl font-bold text-gray-900 mb-6">
            MD Course <span className="text-gradient">Eligibility Requirements</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Meet the essential criteria to pursue your MD specialization and advance your medical career.
          </p>
        </motion.div>
