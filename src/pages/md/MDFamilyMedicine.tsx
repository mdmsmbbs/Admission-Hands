          ...
          <div className="flex-1">
            ...
            >
              <motion.div className="text-center mb-8" variants={fadeInUp}>
                ...
                <h1 className="text-4xl font-bold text-foreground">MD Family Medicine</h1>
                <p className="text-xl text-muted-foreground mt-4 max-w-3xl mx-auto">
                  Holistic healthcare across age groups and diseases with comprehensive family-centered approach
                </p>
              </motion.div>
            </motion.section>
